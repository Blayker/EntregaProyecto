...
namespace SuperMercado
{
    public class clsFactura
    {
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = " Tipo        cantidad     Precio     Total";   // agrega lineas de  encabezados
            ...
            public void AgregaArticulo(string Articulo, string? v, double precio, int cant, double subtotal)
            {
